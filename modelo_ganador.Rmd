...
train_df <- na.aggregate(train_df, FUN = mean)
head(train_df)
```
...
predictores <- c("housing_median_age", "total_rooms","median_income", "households", "total_bedrooms", "ocean_proximity")
...
xgb_model <- xgboost(data = as.matrix(X_xgb), 
                     ...
                     nrounds = 2000,
                     eta = 0.4,
                     objective = "reg:squarederror") # Mejor modelo de momento 44435.01314
